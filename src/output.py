...
class Pager:
    ...
    def __init__(self, dht: DHT22, config: Config, environment: EnvironmentControl):
        ...
        self._overview_page = OverviewPage(self._display.framebuffer(), self._display._width, self._display._height)
        self._config_page = ConfigPage(self._display.framebuffer(), self._display._width, self._display._height, self._config)
        self._error_page = ErrorPage(self._display.framebuffer(), self._display._width, self._display._height)
